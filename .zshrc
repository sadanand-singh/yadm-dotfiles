...
# export LDFLAGS="-L/usr/local/opt/readline/lib -L/usr/local/opt/sqlite/lib -L/usr/local/opt/ruby/lib -L/usr/local/opt/ncurses/lib -L/usr/local/opt/openssl@1.1/lib -L/usr/local/opt/curl/lib $LDFLAGS"
# export CPPFLAGS="-I/usr/local/opt/readline/include -I/usr/local/opt/sqlite/include -I/usr/local/opt/ruby/include -I/usr/local/opt/ncurses/include -I/usr/local/opt/openssl@1.1/include -I/usr/local/opt/curl/include $CPPFLAGS"
